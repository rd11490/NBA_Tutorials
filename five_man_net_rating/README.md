...
#### Code can be found [Here](possession_histogram.py) and [Here](net_rtg_by_team.py)
...
#### Code can be fou# Five Man Lineup Net Rating Are Bad
...
#### Code can be found [Here](net_rtg_simulation.py)
...
#### Code can be found [Here](net_rtg_run.py)
